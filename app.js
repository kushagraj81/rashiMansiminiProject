...
// var ctc=new appointmentModel({content:"alpha gama beta",
// time:"16 baje"});
...
app.get('/userHome',isLoggedIn,function(req,res){
    ...
    User.findById(req.user.id,function(err,foundUser){
        ...
        else
        {
            ...
            res.render('userHome',{userName:foundUser.username,appointment:foundUser.appointment});
        ...
        else
        {
            ...
            if(foundUser.appointment.length==1)
            {
                ...
                else
                {
                    ...
                    // { 
                    //     if(foundUser.appointment[i].id.trim()===appoID.trim())
                    //     {
...
var ctc=new Appointment({phonenumber:req.body.phnumber,
    name:req.body.name,
    age:req.body.age,
